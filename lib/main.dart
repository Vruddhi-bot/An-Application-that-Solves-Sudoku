...
class _SudokuState extends State<Sudoku> {
  ...
  uploadImg() async{
    ...
    setState(() {
      // path = "C:\\Users\\Vruddhi Parag Tolia\\AndroidStudioProjects\\sudoku_solver_application\\images\\solved_image.png";
      path = "${directory.path}/solved_image.png";
      loading = false;
      Navigator.of(context).pop();
      // path = "/data/user/0/com.example.sudoku_solver_application/app_flutter/flutter_assets/solved_image.png";
      // path = "images/sudukoImg.png";
